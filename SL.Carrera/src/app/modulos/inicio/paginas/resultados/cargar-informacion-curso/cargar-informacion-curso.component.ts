...
@Component({
  selector: 'app-cargar-informacion-curso',
  templateUrl: './cargar-informacion-curso.component.html',
  styleUrls: ['./cargar-informacion-curso.component.scss']
})
export class CargarInformacionCursoComponent extends BaseController implements OnInit, AfterViewChecked {
  ...
  public loadForm() {
    this.form = this.fb.group(
      {
        id: new FormControl(''),
        nombreInstructivone: new FormControl('', [Validators.required]),
