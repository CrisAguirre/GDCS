...
import { ProducionService } from '@app/core/servicios/produccion-service';
import { Constants as C } from '@app/compartido/helpers/constants';

@Component({
  selector: 'app-produccion-intelectual',
  templateUrl: './produccion-intelectual.component.html',
  styleUrls: ['./produccion-intelectual.component.scss']
})
export class ProduccionIntelectualComponent extends BaseController implements OnInit, AfterViewChecked {
  ...
  public async loadData() {
    ...
    this.lstCategoriaPublicacion = (await this.commonService.getCategoriaPublicacion().toPromise() as any).datos as CategoriaPublicacion[];
    this.lstPublicacion = (await this.ps.getPublicacionUsuario(this.user.id).toPromise() as any).datos as Publicacion[];
