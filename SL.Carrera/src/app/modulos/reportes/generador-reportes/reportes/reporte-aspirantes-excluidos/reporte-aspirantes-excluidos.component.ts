import { AspiranteExcluidoModel } from './../../../../../compartido/modelos/reportes/aspirante-excluido-model';
...
@Component({
  selector: 'app-reporte-aspirantes-excluidos',
  templateUrl: './reporte-aspirantes-excluidos.component.html',
  styleUrls: ['./reporte-aspirantes-excluidos.component.scss']
})
export class ReporteAspirantesExcluidosComponent extends BaseController implements OnInit, AfterViewChecked {
  ...
  public formValid(val) {
    if (val && this.form.valid) {
      const dataReport: AspiranteExcluidoModel = Constants.initReportModel();
