...
@Component({
  selector: 'app-reporte-preseleccionados',
  templateUrl: './reporte-preseleccionados.component.html',
  styleUrls: ['./reporte-preseleccionados.component.scss']
})
export class ReportePreseleccionadosComponent extends BaseController implements OnInit, AfterViewChecked {
  ...
  ngOnInit(): void {
    ...
    this.commonService.getVarConfig(configMsg.RPT_PARAMETROS_PRESELECCIONADOS).then(v => {
      this.setJson(v);
