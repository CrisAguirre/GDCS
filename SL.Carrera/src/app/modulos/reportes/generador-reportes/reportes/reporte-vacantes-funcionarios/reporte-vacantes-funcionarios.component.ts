...
@Component({
  selector: 'app-reporte-vacantes-funcionarios',
  templateUrl: './reporte-vacantes-funcionarios.component.html',
  styleUrls: ['./reporte-vacantes-funcionarios.component.scss']
})
export class ReporteVacantesFuncionariosComponent extends BaseController implements OnInit, AfterViewChecked {
  ...
  public async loadData() {
    ...
    const config = <any>(<any>await this.commonService.getMessageByName(configMsg.ESTADO_ASPIRANTE_INSCRITO).toPromise()).datos;
